export const config = {
// PROFILE PHOTO EDIT
  profilePhotoEditForm: document.querySelector('.popup_type_photo'),
...
// PROFILE EDIT
  ...
  profileCloseButton: document.querySelector('.popup__close-button_type_profile'),
  nameInput: document.querySelector('.popup__input_type_name'),
  quoteInput: document.querySelector('.popup__input_type_quote'),
  profileName: document.querySelector('.profile__name'),
  profileQuote: document.querySelector('.profile__quote'),
// ADD START 6 CARDS
  elementsTemplate: document.querySelector('#elements__template').content,
  elementsList: document.querySelector('.elements__list'),
// ADD NEW CARDS
  elementsAddForm: document.querySelector('.popup_type_card-add'),
  elementsAddButton: document.querySelector('.profile__add-button'),
